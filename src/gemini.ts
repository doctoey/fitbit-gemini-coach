...
- เขียนเนื้อหาของแต่ละส่วนต่อกันเป็นพารากราฟสั้นๆ ที่ลื่นไหล ไม่ต้องทำเป็นข้อๆ หรือแยกบรรทัดใหม่ให้กับคำแนะนำแต่ละข้อ แต่ให้ใช้คำเชื่อม (เช่น นอกจากนี้, และ) เพื่อเชื่อมร้อยคำแนะนำ 2-3 ข้อเข้าด้วยกันในพารากราฟเดียวอย่างเป็นธรรมชาติ

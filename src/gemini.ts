...
- โครงสร้างและย่อหน้า (เข้มงวดมาก): 
  ...
  - บรรทัดถัดมา: แสดงส่วน "คำแนะนำ" โดยเริ่มบรรทัดด้วย "- คำแนะนำสำหรับวันนี้: " จากนั้นให้ขึ้นบรรทัดใหม่และย่อหน้าเข้าไปเล็กน้อยเพื่อแสดงรายการคำแนะนำย่อยทีละข้อโดยใช้เครื่องหมายขีดแดช (-) นำหน้า (เช่น - ปรับเวลาเข้านอน...) ห้ามใช้ตัวเลขหรือตัวหนา เมื่อจบส่วนนี้ให้เว้นบรรทัดว่าง 1 บรรทัด
